...
export const SpecialistsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Маркетплейс специалистов</h1>
        <p className="text-sm text-gray-500">Найдите проверенных фрилансеров и экспертов для вашего бизнеса</p>
      </div>
        ...
        {filtered.map((s) => (
          ...
          >
            <div className="space-y-3">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-indigo-600 dark:text-indigo-400 font-medium">{s.profession}</p>
                  </div>
                </div>
              ...
              <p className="text-xs text-gray-600 dark:text-gray-300 line-clamp-2">{s.bio}</p>
